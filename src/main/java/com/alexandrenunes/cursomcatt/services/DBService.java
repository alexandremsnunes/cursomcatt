...
import com.alexandrenunes.cursomcatt.domain.PagamentoComBoleto;
import com.alexandrenunes.cursomcatt.domain.PagamentoComCartao;
import com.alexandrenunes.cursomcatt.domain.Pedido;
import com.alexandrenunes.cursomcatt.domain.Produto;
import com.alexandrenunes.cursomcatt.domain.enums.EstadoPagamento;
import com.alexandrenunes.cursomcatt.domain.enums.Perfil;
...
import com.alexandrenunes.cursomcatt.repositories.ItemPedidoRepository;
import com.alexandrenunes.cursomcatt.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "msn.alexandre@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "alexandremagnodasilvanunes@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
